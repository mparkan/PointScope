...
THREE.TrackballControls = function ( object, domElement ) {
	...
	this.object = object;
	if (domElement == undefined){console.log('domElement == undefined')}
	if (domElement !== undefined){console.log('domElement !== undefined')}
	
	
	this.domElement = ( domElement !== undefined ) ? domElement : document; //document
	...
	/*
	try {
		this.domElement.removeEventListener('mouseup', mousedown, false );
	} 
	catch(err) {
		console.log('no mouseup')
	};
	*/
